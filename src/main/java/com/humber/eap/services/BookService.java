...
public class BookService {
	...
	public void addBook(Book book) throws Exception {
		...
		if(isExist) throw new Exception("The book titled " + book.getName() + " already exists in the database. Please try a adding a new book!");
	...
	public void updateBook(Book book) throws Exception {
		...
		if(!isExist) throw new Exception("The book titled " + book.getName() + " doesn't exist in the database.");
		bookRepository.save(book);
	}
	...
	public void deleteBookById(int id) throws Exception {
		...
		if(!isExist) throw new Exception("The book with id " + id + " doesn't exist in the database.");
	}
